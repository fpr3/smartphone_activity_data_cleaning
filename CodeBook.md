...
The raw data was preprocessed by the authors of the initial study using standard methods to provide analysis-ready measurement data. The resulting data is well defined in the [documentation](http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones#) provided by these authors. Additional detail is available in the [UCI%20HAR%20Dataset.names](http://archive.ics.uci.edu/ml/machine-learning-databases/00240/UCI%20HAR%20Dataset.names) file describing the activities assessed, the angular velocity parameters reported and the accelleration signals recorded.
